  ...
  int p;
{
  ...
  /* pid has to be static in order for Yield() to return the int of the last
     process that was running before control was given back to this process */
  pid = GetCurProc ();
