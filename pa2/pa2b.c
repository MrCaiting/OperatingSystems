...
void Main ()
{
	if (Fork () == 0) { //1
		...
		if (Fork () == 0) { //3
			...
			if (Fork () == 0) {
				...
				SlowPrintf (2, "666666");	/* process 4 */
				Exit ();
			}

			SlowPrintf (4, "444444444444444");	/* process 4 */
			

			if (Fork () == 0) {

				SlowPrintf (2, "7777777777777777777");	/* process 4 */
				Exit ();
			}
	...
	if (Fork () == 0) { //2
		...
		SlowPrintf (1, "3333333");		/* process 3 */
		Exit ();
	}

	SlowPrintf (3, "1111111111111111111111111111111");			/* process 1 */
	Exit ();
}
